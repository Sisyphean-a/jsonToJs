...
- **四列布局设计**：JSON输入 → JSON预览 → 代码编辑 → 结果预览
- **实时数据同步**：所有面板数据实时联动更新
...
1. **数据输入**：在左侧面板输入或粘贴JSON数据
2. **数据预览**：第二列实时显示解析后的JSON结构
3. **代码编写**：第三列编写JavaScript转换逻辑
4. **结果查看**：第四列显示转换后的结果
